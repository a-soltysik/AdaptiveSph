...
public:
    ...
    void updateBoundarySize(const RunData& runData,
...
template <typename Func>
void NeighborGrid::Device::forEachFluidNeighbor(glm::vec4 position,
                                                const glm::vec4* positions,
                                                float smoothingRadius,
                                                Func&& func)
{
...
template <typename Func>
void NeighborGrid::Device::forEachBoundaryNeighbor(glm::vec4 position,
                                                   const glm::vec4* boundaryPositions,
                                                   float smoothingRadius,
                                                   Func&& func)
{
...
inline auto NeighborGrid::Device::calculateCellIndex(glm::vec4 position) const -> glm::ivec3
{
...
inline auto NeighborGrid::Device::flattenCellIndex(glm::ivec3 cellIndex) const -> uint32_t
{
