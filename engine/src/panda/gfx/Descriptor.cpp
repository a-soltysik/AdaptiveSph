...
{
    expect(_device.logicalDevice.freeDescriptorSets(_descriptorPool, descriptors),
           vk::Result::eSuccess,
           "Failed to free descriptor sets");
}

auto DescriptorPool::resetPool() const -> void
{
    expect(_device.logicalDevice.resetDescriptorPool(_descriptorPool),
           vk::Result::eSuccess,
...
auto DescriptorWriter::push(vk::CommandBuffer commandBuffer, vk::PipelineLayout layout) const -> void
{
